    ...
    <div className="p-4 border rounded-lg shadow-md bg-white w-full max-h-96 overflow-y-auto mb-2">
      <div className="flex justify-between items-center mb-2 border-b pb-2">
        ...
        <span
          ...
          className="text-gray-500 hover:text-gray-700 focus:outline-none cursor-pointer transition-colors duration-150 inline-flex items-center justify-center"
      ...
      {showWords ? (
        <p className="text-justify text-gray-800 break-words leading-relaxed">{words}</p>
      ) : (
        <p className="text-sm italic text-gray-500 text-center py-4">
          Word list hidden. Click the eye icon above to reveal.
        </p>
      )}
    </div>
  );
